    ...
    return (
        <section className="relative min-h-screen flex flex-col justify-center items-center text-center px-5 py-20 overflow-hidden">
            ...
            <div className="relative z-10 max-w-4xl w-full animate-fadeInUp flex flex-col items-center">
                ...
                <div className="flex flex-col md:flex-row flex-wrap justify-center gap-2 md:gap-4 mb-5 md:mb-8 text-xs md:text-base font-medium text-white/90 w-full max-w-lg">
                    <div className="flex justify-center items-center gap-3 md:gap-4 w-full whitespace-nowrap">
                        <span className="flex items-center gap-1">✓ Mínimo 15 Peças</span>
